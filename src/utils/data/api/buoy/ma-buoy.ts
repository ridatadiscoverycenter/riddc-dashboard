...
const VARIABLE_PAIRS: { viewer: MaBuoyViewerVariable; erddap: MaBuoyErddapVariable }[] = [
  ...
  { viewer: 'O2PercentQualifiersBottom', erddap: 'O2PercentQualifiersBottom' },
  { viewer: 'O2PercentSurface', erddap: 'O2PercentSurface' },
  { viewer: 'O2QualifiersBottom', erddap: 'O2QualifiersBottom' },
  { viewer: 'O2QualifiersSurface', erddap: 'O2QualifiersSurface' },
  { viewer: 'O2Surface', erddap: 'O2Surface' },
  { viewer: 'pHQualifiersBottom', erddap: 'pHQualifiersBottom' },
  { viewer: 'pHQualifiersSurface', erddap: 'pHQualifiersSurface' },
  { viewer: 'pHSurface', erddap: 'pHSurface' },
  { viewer: 'PhycoerythrinBottom', erddap: 'PhycoerythrinBottom' },
  { viewer: 'PhycoerythrinQualifiersBottom', erddap: 'PhycoerythrinQualifiersBottom' },
  { viewer: 'PhycoerythrinQualifiersSurface', erddap: 'PhycoerythrinQualifiersSurface' },
  { viewer: 'PhycoerythrinSurface', erddap: 'PhycoerythrinSurface' },
  { viewer: 'SalinityBottom', erddap: 'SalinityBottom' },
  { viewer: 'SalinityQualifiersBottom', erddap: 'SalinityQualifiersBottom' },
  { viewer: 'SalinityQualifiersSurface', erddap: 'SalinityQualifiersSurface' },
  { viewer: 'SalinitySurface', erddap: 'SalinitySurface' },
  { viewer: 'SpCondBottom', erddap: 'SpCondBottom' },
  { viewer: 'SpCondQualifiersBottom', erddap: 'SpCondQualifiersBottom' },
  { viewer: 'SpCondQualifiersSurface', erddap: 'SpCondQualifiersSurface' },
  { viewer: 'SpCondSurface', erddap: 'SpCondSurface' },
  { viewer: 'WaterTempBottom', erddap: 'WaterTempBottom' },
  { viewer: 'WaterTempQualifiersBottom', erddap: 'WaterTempQualifiersBottom' },
  { viewer: 'WaterTempQualifiersSurface', erddap: 'WaterTempQualifiersSurface' },
