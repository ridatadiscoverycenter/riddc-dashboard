  ...
  return (
    <FullBleedColumn className="my-2 gap-4 font-light font-lg">
      ...
      <List items={[
        ...
        { label: "NERACOOS", value: "Northeast Regional Association Coastal Ocean Observing Systems" }, 
        { label: "RI C-AIM", value: "Rhode Island Consortium for Coastal Ecology Assessment, Innovation, and Modeling" }, 
        { label: "RIC", value: "Rhode Island College" }, 
        { label: "RIDDC", value: "Rhode Island Data Discovery Center" }, 
        { label: "RIDEM-OWR", value: "Rhode Island Department of Environmental Monitoring-Office of Water Resources" }, 
        ...
        { label: "URI-GSO", value: "University of Rhode Island, Graduate School of Oceanography" }, 
      ]} />
      <h2 className="text-2xl">Data Variables</h2>
      <List items={[
        { label: "Chlorophyll (µg L-1 or RFU)", value: "Concentration of chlorophyll in sea water" }, 
        ...
        { label: "FSpercent (% full scale)", value: "Total fluorescence of chlorophyll in sea water" }, 
        ...
        { label: "Phycoerythrin (µg L-1 or RFU)", value: "Concentration of phycoerythrin in sea water" }, 
        ...
        { label: "Turbidity (NTU)", value: "Sea water clarity measured with white light at 90° detection angle" }, 
...
function List({ items }: { items: { label: string, value: string }[]}) {
  return (
    <ul className="flex flex-col gap-1">
      {items.map(({ label, value }) => (<li key={label}><span className="font-bold">{label}</span>: {value}</li>))}
    </ul>
  )
}
