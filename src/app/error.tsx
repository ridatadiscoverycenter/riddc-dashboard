  ...
  return (
    <FullBleedColumn className="w-full mt-10">
      <Card className="bg-white/80 dark:bg-white/10 w-full">
        <Header tag="h1" size="md">
          Oh No! An Error as occured.
        </Header>
        <pre className="bg-white/90 dark:bg-white/10 rounded-md p-2">{error.message}</pre>
        <Button onClick={() => setShowStackTrace((currentValue) => !currentValue)}>
          View Stack Trace
        </Button>
        ...
        <p>
          ...
          <ExternalLink href="mailto:support@ccv.brown.edu">CCV Support</ExternalLink> with the
          issue!
        </p>
      </Card>
    </FullBleedColumn>
