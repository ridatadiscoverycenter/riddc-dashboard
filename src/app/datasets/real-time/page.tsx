...
export default async function RealTime({ searchParams }: PageProps) {
  ...
  return (
    <>
      <p className="mt-6">
        The real time buoys are currently undergoing maintinence, and have not reported data since
        ...
        description={
          <div className="w-full flex flex-col gap-2 my-2">
            ...
            <p>
              ...
              <ExternalLink href="https://pricaimcit.services.brown.edu/erddap/search/index.html?page=1&itemsPerPage=1000&searchFor=Buoy+Telemetry">
                ERDDAP
              </ExternalLink>
              .
            </p>
            <p>
              ...
              <ExternalLink href="https://pricaimcit.services.brown.edu/erddap/info/buoy_telemetry_0ffe_2dc0_916e/index.html">
